...
<template>
  <div>
    ...
    <section class="section surface-navy"><div class="container grid-2"><div><p class="eyebrow">EU · EURO · ADRIATIC</p><h2 class="section-title">{{ site.home.whyTitle }}</h2><p class="section-copy" style="color:rgba(255,255,255,.76)">{{ site.home.whyText }}</p><div class="button-row"><NuxtLink class="button button--light" :to="localePath('/why-croatia')" :aria-label="`${t('actions.discover')}: ${site.home.whyTitle}`">{{ t('actions.discover') }}</NuxtLink></div></div><div class="stats-row"><div class="stat"><strong>EU</strong><span>European Union</span></div><div class="stat"><strong>€</strong><span>Euro currency</span></div><div class="stat"><strong>1,700+</strong><span>km coastline</span></div><div class="stat"><strong>365</strong><span>days of opportunity</span></div></div></div></section>
